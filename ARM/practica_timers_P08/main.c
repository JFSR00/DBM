...
int main(void)
{
    ...
    while (TRUE)
    {
        // Imprimir el cronometro en la coordenada (0, 0) de la pantalla.
				glcd_xprintf(0, 0, BLANCO, NEGRO, FONT12X24, "%02d:%02d:%02d", horas, minutos, segundos);
...
int main(void)
{
    ...
    while (TRUE)
    {
        ...
        // Imprimir "Pulsa abajo para comenzar" en el LCD.
				glcd_xprintf(0, 0, BLANCO, NEGRO, FONT16X32, "Pulsa abajo para comenzar");
        //glcd_printf("Pulsa abajo para comenzar");
        ...
        // Imprimir "¡Preparado!" en el LCD.
				glcd_xprintf(0, 0, BLANCO, NEGRO, FONT16X32, "¡Preparado!");
        //glcd_printf("¡Preparado!");
         
        // Generar un número aleatorio entre 1000 y 5000.
        tiempo_aleatorio = 1000 + (rand()%4001);
        ...
        // Leer el valor del registro contador del timer 0. El valor obtenido es el tiempo en milisegundos
				// entre el momento en que la pantalla cambia a color rojo y el instante en el que el usuario pulsa
				// el joystick hacia el centro = tiempo de reacción.
        tiempo_reaccion = timer_leer(TIMER0);
  
        // Imprimir en la pantalla el tiempo de reacción.
				glcd_xprintf(0, 0, ~ROJO, ROJO, FONT16X32, "Tiempo de reacción %d ms", tiempo_reaccion);
        //glcd_printf("%d", tiempo_reaccion);
