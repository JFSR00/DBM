                             ...
                             uint32_t periodo_en_ms)
{
	...
	timer_regs->MCR = 3;		// De esta forma el contador no se para, empezando de nuevo a contar para la próxima vez que la función sea llamada, evitando los retardos producidos por las
	timer_regs->IR = 1;			// otras instrucciones que se ejecuten por el programa
	timer_regs->TCR = 1;
}
